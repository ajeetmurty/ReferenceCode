...
//
//	public Phonebook(String template, String defaultName, String defaultPhone) {
...
//	@GET
//	@Timed
//	public Person sayHello(@Context HttpServletRequest httpRequest, @QueryParam("firstname") Optional<String> firstName) {
